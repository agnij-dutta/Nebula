...
const socials = [
  ...
  {
    name: 'LinkedIn',
    url: 'https://www.linkedin.com/in/agnij-dutta/',
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
...
export default function Footer() {
  return (
    <footer className="section-spacing glass-effect mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          {/* Logo and Description */}
          <div className="col-span-1 md:col-span-2">
            <Link href="/" className="text-2xl font-bold bg-gradient-text">
              Nebula
            </Link>
            <p className="mt-4 text-gray-300">
              Revolutionizing scientific research through decentralized infrastructure.
